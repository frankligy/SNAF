...
stats = mannwhitneyu(n_common,n_unique)[1]
print(stats)
all_patients.pop(all_patients.index('Mel-16'))
all_patients.pop(all_patients.index('Mel-39'))
all_patients.pop(all_patients.index('Mel-40'))
all_patients.pop(all_patients.index('Mel-41'))
all_patients.pop(all_patients.index('Mel-42'))
for p in all_patients:
...
# burden,burden_encode,burden_vc,quantiles = snaf.survival_analysis(burden,survival,n=2,stratification_plot='result/stage3_stratify.pdf',survival_plot='result/stage3_survival.pdf')
# print(quantiles)
