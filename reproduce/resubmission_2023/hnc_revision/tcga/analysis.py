...
# inspection
bam_path_list = ['/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-HNSCC/TCGA-CV-A45Y-01A.bam',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-HNSCC/TCGA-P3-A6T8-01A.bam',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-Bladder/TCGA-BT-A20U-11A.bam',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-THCA/TCGA-ET-A3DW-11A.bam',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-COLORECTAL/BAMS/TCGA-AA-3713-11A-01R-1723-07.bam']
bai_path_list = ['/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-HNSCC/TCGA-CV-A45Y-01A.bai',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-HNSCC/TCGA-P3-A6T8-01A.bai',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-Bladder/TCGA-BT-A20U-11A.bai',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-THCA/TCGA-ET-A3DW-11A.bam.bai',
                 '/data/salomonis-archive/BAMs/NCI-R01/TCGA/TCGA-COLORECTAL/BAMS/TCGA-AA-3713-11A-01R-1723-07.bam.bai']
outdir = '../Frank_inspection/ggsashimi_run_folder'
sif_anno_path = '/data/salomonis2/software/ggsashimi'
bam_contig_rename = [False,False,False,False,False]
...
snaf.JunctionCountMatrixQuery.deserialize('result/after_prediction.p').visualize(uid=uid,sample='TCGA-HD-8224-01A.bed',outdir='../Frank_inspection')
