...
function run(){
    # run STAR
    FASTQORI=/data/salomonis-archive/FASTQs/PublicDatasets/ProliferatingSkinCell/Fastq/${1}.fastq
    FASTQ=/data/salomonis-archive/FASTQs/PublicDatasets/ProliferatingSkinCell/Fastq/${1}.fastq.gz
...
cat samples_single_end.txt | parallel -P 5 run {}
