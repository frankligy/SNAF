...
python /data/salomonis2/software/AltAnalyze-91/AltAnalyze/AltAnalyze.py --species Hs --platform RNASeq --version EnsMart91 \
    --bedDir /data/salomonis-archive/FASTQs/PublicDatasets/scRNA-Seq/aviv_melanoma_Frank/beds \
    --output /data/salomonis-archive/FASTQs/PublicDatasets/scRNA-Seq/aviv_melanoma_Frank/altanalyze_output \
    --groupdir /data/salomonis-archive/FASTQs/PublicDatasets/scRNA-Seq/aviv_melanoma_Frank/altanalyze_output/ExpressionInput/groups.${task}.txt \
    --compdir /data/salomonis-archive/FASTQs/PublicDatasets/scRNA-Seq/aviv_melanoma_Frank/altanalyze_output/ExpressionInput/comps.${task}.txt --expname ${task} \
    --runGOElite no