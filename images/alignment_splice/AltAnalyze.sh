...
python /data/salomonis2/software/AltAnalyze-91/AltAnalyze/AltAnalyze.py --species Hs --platform RNASeq --version EnsMart91 \
    --bedDir /data/salomonis-archive/BAMs/NCI-R01/GTEx/newSkin_100922/Frank/beds \
    --output /data/salomonis-archive/BAMs/NCI-R01/GTEx/newSkin_100922/Frank/altanalyze_output \
    --groupdir /data/salomonis-archive/BAMs/NCI-R01/GTEx/newSkin_100922/Frank/altanalyze_output/ExpressionInput/groups.${task}.txt \
    --compdir /data/salomonis-archive/BAMs/NCI-R01/GTEx/newSkin_100922/Frank/altanalyze_output/ExpressionInput/comps.${task}.txt --expname ${task} \
    --runGOElite no