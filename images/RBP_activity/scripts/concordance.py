...
def concordant_analysis(query_file_path,reference_file_path,pval=0.05):
    # read file
    ...
    result = '{}-{}-{}-{}-{}'.format(round(frac,2),round(common.shape[0],2),round(common.shape[0]/query.shape[0],2),round(common.shape[0]/reference.shape[0],2),p_val)
    return result
