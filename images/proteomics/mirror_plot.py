...
exp_scan_num = 15779
syn_scan_num = 31110
mirror_plot(exp_mzml,syn_mzml,exp_scan_num,syn_scan_num,
            xlim=(0,1000),
            ions=[('y',1,1),('y',6,1),('y',7,1),('y',8,1),('b',2,1),('b',3,1),('b',8,1),('M',None,2)],
            seq='YALANIKWI')
...
'''
Instructions
1. I use a conda enviroment with python 3.7, and then install pyteomics and other necessary packages
2. each ion is a tuple (ion_type, position, charge), either b ion, y ion or precursor ion
'''
